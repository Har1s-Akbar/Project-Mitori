        ...
        while retry_counter>0:
            try:
                ...
                if order_side == "sell":
                    ...
                    available_shares = await pipeline.hget(f'cache:position:{order_user_id}', order_ticker)
                    locked_shares = await pipeline.hget(f'cache:position:{order_user_id}', f'locked_{order_ticker}')
